...
def create_city_in_country(country_id):
    ...
    name = get_name(json)
    city = City(name=name, country_id=country_id) # creamos el país que queremos dar de alta
    
    city.save()  # llamo a la función "save" (está en los modelos) para guardar el país en la BBDD
